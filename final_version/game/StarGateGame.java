...
public class StarGateGame extends JPanel implements ActionListener {
	...
	//a pálya elemeit tartalmazó láncolt lista
	...
	public StarGateGame() {
		...
		timer.start();
		String info=new String("Jatek vezerlese:\n\n Colonel (Indulas: Bal felso sarok):\n Fel nyil - Mozgas fel\n "
				+ "Le nyil - Mozgas le\n Jobbra nyil - Mozgas jobbra\n Balra nyil - Mozgas balra\n "
				+ "B - Doboz fel/le\n N - Sarga lovedek\n M - Kek lovedek\n\n"
				+ "Jaffa (Indulas: Jobb felso sarok):\n W - Mozgas fel\n S - Mozgas le\n D - Mozgas jobbra\n A - Mozgas balra\n "
				+ "F - Doboz fel/le\n E - Piros lovedek\n Q - Zold lovedek\n");
	...
	/*
	 * A txtböl feltöltött tömb gettere
	 */
	public Map getMap(){
		return this.m;
	}
    ...
    private void startpopup(String message) {
        int n = JOptionPane.showOptionDialog(null, message, "Directing informations", JOptionPane.DEFAULT_OPTION,
    ...
    /*
     * Játék befejezeséért felelős függvény
     * Megívódik, ha meghal egy játékos, vagy zpm felvétel történik
    ...
    public void EndofGame() {
        ...
        /*
         * Ha elérjük az összes felvehető zpm-ek  számát, és
         * Ha a colonel vett fel több zpm-et, életben van, akkor a Colonel nyert, egyébként a Jaffa 
         */
	...
	public void buildMAP() {
		 ...
		 * elemek egyesével történő hozzáadásával
		 * 
		 * 30x30-as pálya
		 */
		for (int x = 0; x < 30; x++) {
	...
	public void paint(Graphics g) {
		...
		//colonel által kilőtt lövedék kirajzolása
		if (c.getBullet() != null) {
			c.getBullet().render(g);
		}
		
		//jaffa által kilőtt lövedék kirajzolása
		if (j.getBullet() != null) {
	...
	public class Cntrl extends KeyAdapter {
		...
		public void keyPressed(KeyEvent e) {
			...
			if (c.getisAlive()) {
				...
				if (keycode == KeyEvent.VK_UP) {
					//Ha nincs lenyomva billentyű akkor lépünk a Colonellel
				...
				if (keycode == KeyEvent.VK_RIGHT) {
					...
					if (replicator.getisAlive() == true)
						replicator.move();
					//Lenyomott billentyűzet jelzése
					keypressedC = true;
			...
			if (j.getisAlive()) {
				...
				if (keycode == KeyEvent.VK_W) {
					//Ha nincs lenyomva billentyű akkor lépünk a Jaffaval
					//beállítjuk milyen irányba néz
				...
				if (keycode == KeyEvent.VK_Q){
					...
					if (j.getPortalGreen_y() != -1 && j.getPortalGreen_x() != -1) {
						...
						//-1-el jelezzük, hogy nincs nyitott porál
				...
				if (keycode == KeyEvent.VK_F) {
					...
					//ha dobozzon állunk, és nincs kezünkben még doboz, akkor felvesszük,
					//ha van a kezünkben akkor rárakjuk a másik dobozra, vagy a helyen még nincs doboz, akkor
					//simán lerakjuk, és lesz ott egy doboz
					if (chechIfStangindOnBox) {
						if (j.gethaveBox()) {
		...
		/*
		 * Karakterek mozgatásához a léptető billentyűzetek
		 * lenyomásakor a keypressedC és keypressedJ változókat
		 * true-ra állítjuk, hogy ne lehessen lenyomva tartani a billentyűt
		 * és folyton lépni a karakterrel
		 * Ezt felengedéskor false-ra állítjuk, hogy léphessünk megint a következő lenyomáskor.
		 * 
		 * @see java.awt.event.KeyAdapter#keyReleased(java.awt.event.KeyEvent)
		 */
		public void keyReleased(KeyEvent e){
			int keycode = e.getKeyCode();
			//Ha él a colonel akkor figyeljük a billentyűfelengedést,úgy mint a lenyomást
			if (c.getisAlive()) {
				if (keycode == KeyEvent.VK_UP) {
					keypressedC = false;
				}
			...
			//Ha él a jaffa akkor figyeljük a billentyűfelengedést, úgy mint a lenyomást
			if(j.getisAlive()){
				if (keycode == KeyEvent.VK_W) {
					keypressedJ = false;
				}
