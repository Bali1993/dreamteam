...
public class StarGateGame extends JPanel implements ActionListener {
	...
	// maximum zpm szám amit fel lehet venni!!!
	private int zpmdb;
	...
	//kepbeolvasasok miatt szüksegek az Element-ek szamara egy referencia a Map-re
	public Map getMap(){
		return this.m;
	}
	...
	public void buildMAP() {
		...
		// majd �jra v�gig megy�nk a p�ly�n �s most m�r l�trehozzuk a m�rlegeket
		// is
	...
	/*
	 * itt rajzoljuk ki, az�rt k�l�n mert k�l�nben mindig �jrat�lten� fel a
	 * list�nkat a k�l. elemekkel
	 * 
