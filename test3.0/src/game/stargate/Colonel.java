...
public class Colonel{	
	...
	//private int zpmCounter; majd a rendes játékhoz
	...
	public Colonel(StarGateGame g){		
		...
		this.haveBox = false;
		this.facing = "down";
		//this.zpmCounter = 0; majd a rendes játékhoz
	...
	public void haveBoxInverter(){
		for(int j = 0; j < StarGateGame.tab; j++)
			System.out.print("\t");
		System.out.println("-> [:Colonel].haveBoxInverter();");
		...
		for(int j = 0; j < StarGateGame.tab; j++)
			System.out.print("\t");
		System.out.println("<- [:Colonel].haveBoxInverter():void;");
	}
